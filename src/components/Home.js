    ...
    return (
        <div className='home'>
            ...
            <div className="home__container">
                ...
                <div className="home__row">
                    <Product  id="97883" image="https://m.media-amazon.com/images/I/81rDAWdv5kL._SL1500_.jpg" title="Amazon Brand - Symactive Racer S2000 Series, 27.5T Geared Mountain Bike (Shimano 21-Speed Gear), Front Suspension, Dual Disc Brake, Frame Size: 15.5 inch, Alloy Stem (Green, Unisex)" price={10900} rating={5} />
                    ...
                    <Product  id="924238905" image="https://m.media-amazon.com/images/I/71rH7Skt1QL._SX679_.jpg" title="KOLOROBIA SRI Lankan Tropical Rainforest Wildlife Elephant Inspired Home DÉCOR Wall Plate 7.5 INCH" rating={3} price={1395} />
                </div>
                <div className="home__row">
